  ...
  const features = [
    {
      ...
      description:
        "Sign up and start working today with instant access to thousands of micro jobs.",
    },
    {
      icon: Users,
      title: "Full Customization",
      description:
        "Build your freelancer profile or job posting exactly the way you want it.",
    },
    {
      icon: Shield,
      title: "Secure Payments",
      description:
        "Withdraw earnings via trusted methods with our secure payment system.",
    },
    {
      icon: Star,
      title: "Verified Work History",
      description:
        "Build trust with ratings, success rate tracking, and verified level progression.",
    },
    {
      icon: TrendingUp,
      title: "Smart Matching",
      description:
        "AI-powered task feed that matches you with jobs based on your skills and preferences.",
    },
    {
      icon: Clock,
      title: "24/7 Support",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content:
        "FreelanceHub changed my life! I went from struggling to find work to having a steady stream of clients. The platform is incredibly user-friendly.",
    },
    {
      ...
      rating: 5,
      content:
        "The AI matching system is brilliant. I get job recommendations that actually match my skills and interests. Highly recommend!",
    },
    {
      name: "Fatima Khan",
      ...
      rating: 5,
      content:
        "As a business owner, FreelanceHub helps me find quality freelancers quickly. The verification system gives me confidence in my hires.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "You can start applying for jobs immediately after completing your profile. Many freelancers land their first project within 24-48 hours of joining.",
    },
    {
      question: "What payment methods are supported?",
      answer:
        "We support bKash, Nagad, Rocket, bank transfers, and international payment methods like PayPal and Wise for global clients.",
    },
    {
      question: "Is there a commission fee?",
      answer:
        "We charge a small service fee only when you successfully complete a project. Free users pay 10%, Pro users pay 5%, and Business users pay 3%.",
    },
    {
      question: "How does the verification system work?",
      answer:
        "Freelancers can verify their skills through tests, portfolio reviews, and client feedback. Verified badges help you stand out to potential clients.",
    },
    {
      question: "Can I work with international clients?",
      answer:
        "Absolutely! Our platform connects you with clients from around the world, giving you access to global opportunities and competitive rates.",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/signup">
                <Button
                  size="lg"
                  className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 text-lg font-semibold rounded-md transition-all transform hover:scale-105"
                >
                  Get Started
                </Button>
              </Link>
              <Link to="/browse-jobs">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-navy-700 px-8 py-4 text-lg font-semibold rounded-md transition-all"
                >
                  Browse Jobs
                </Button>
              </Link>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everything you need to succeed in the freelance economy, all in
              one platform
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-0 shadow-lg hover:shadow-xl transition-shadow p-6"
              >
                ...
                {[
                  {
                    ...
                    description:
                      "Sign up as employer or freelancer and build your professional profile with skills, portfolio, and experience.",
                  },
                  {
                    step: "02",
                    title: "Post or Browse Jobs",
                    description:
                      "Employers post jobs with clear requirements. Freelancers browse and apply to projects that match their expertise.",
                  },
                  {
                    step: "03",
                    title: "Get Paid",
                    description:
                      "Complete tasks, get approved by clients, and receive secure payments through multiple trusted methods.",
                  },
                ].map((item, index) => (
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center mb-12">
              <span
                className={`mr-3 ${pricingToggle === "monthly" ? "text-navy-700 font-semibold" : "text-gray-500"}`}
              >
                Monthly
              </span>
              <button
                onClick={() =>
                  setPricingToggle(
                    pricingToggle === "monthly" ? "annual" : "monthly",
                  )
                }
              ...
              >
                <div
                  className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow-sm transition-transform ${pricingToggle === "annual" ? "translate-x-7" : "translate-x-1"}`}
                />
              </button>
              <span
                className={`ml-3 ${pricingToggle === "annual" ? "text-navy-700 font-semibold" : "text-gray-500"}`}
              >
                Annual
              </span>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card
                key={index}
                className={`relative border-2 ${plan.popular ? "border-orange-500 shadow-xl scale-105" : "border-gray-200"} rounded-xl p-6`}
              >
                {plan.popular && (
      ...
      <section className="py-20 bg-gradient-to-r from-navy-600 to-navy-800">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who are already earning on
            FreelanceHub
          </p>
          ...
          <div className="grid md:grid-cols-5 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                বাংলাদেশের প্রথম এবং বৃহত্তম মাইক্রো-জব প্ল্যাটফর্ম। প্রতিভাবান
                ফ্রিল্যান্সারদের সাথে গুণগত কাজের সেতুবন্ধন।
              </p>
